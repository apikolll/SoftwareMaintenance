          ...
          <nav id="navbar" class="navbar">
            <ul>
              ...
              <li class="dropdown"><a href="#"><span>Profile</span> <i class="bi bi-chevron-down"></i></a>
                <ul>
                  <li><a href="LibrarianOption.html">View Profile</a></li>
            ...
            <div class="carousel-container">
              <div class="container">
				...
				<center>
					...
					<table>
					  ...
					  ?>
						<tr id="list">
                            ...
                            <td><a id="redlinks" onclick="DeleteBorrower()" href="DeleteBorrower.php?DeleteBorrower=<?php echo $Borrower_ID ?>">Delete</a></td>
						</tr>
					  <?php
						}
					  ?>
					...
					<input type="button" id="addButton" value="Add New Borrower" name="addButton" onclick="location.href='./AddBorrower.php'"><br>
