          ...
          <div class="carousel-item active" style="background-image: url(assets/img/book/book1.jpg)">
            <div class="carousel-container">
              <div class="container">
                ...
                <form action="controller/createReturn.php" method="post">
                  <p class="display-4 text-center">Create</p>
                  ...
                  <div style="color: white;" class="form-group">
                    <label for="LateReturnDay">Late Return Day</label>
                    <input type="number" 
                          class="form-control" 
                          id="LateReturnDay" 
                          name="LateReturnDay" 
                          value="<?php if (isset($_GET['LateReturnDay'])) echo($_GET['LateReturnDay']); ?>"
                          placeholder="Enter Late Return Day">
                  </div><br>
                  ...
                  <div style="color: white;" class="form-group">
                    ...
                    <input type="text" 
                          ...
                          id="ReturnStatus" 
                          name="ReturnStatus" 
                          value="<?php if (isset($_GET['ReturnStatus'])) echo($_GET['ReturnStatus']); ?>"
