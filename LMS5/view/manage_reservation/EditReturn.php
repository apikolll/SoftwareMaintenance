<?php include 'controller/EditReturn.php'; ?>
<html lang="en">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url(assets/img/book/book1.jpg)">
            <div class="carousel-container">
              <div class="container">
                <h4 class="animate__animated animate__fadeInDown">Manage Return Book</h4>
                <div class="container1">
				<form action="controller/EditReturn.php" method="post">
					
				<h5 class="display-4 text-center">Update</h5><hr>
