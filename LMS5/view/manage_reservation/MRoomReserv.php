          ...
          <div class="carousel-item active" style="background-image: url(assets/img/book/book1.jpg)">
            <div class="carousel-container">
              <div class="container">
                ...
                <form action="controller/createRReserv.php" method="post">
                  <h5 style="color: white;" class="display-4 text-center">Create</h5><hr>
                  ...
                  <div style="color: white;" class="form-group">
                    ...
                    <input type="text" 
                          ...
                          id="RoomID" 
                          name="RoomID" 
                          value="<?php if (isset($_GET['RoomID'])) echo($_GET['RoomID']); ?>"
                  ...
                  <div style="color: white;" class="form-group">
                    ...
                    <input type="text" 
                          ...
                          id="RoomName" 
                          name="RoomName"
                          value="<?php if (isset($_GET['RoomName'])) echo($_GET['RoomName']); ?>" 
                  ...
                  <div style="color: white;" class="form-group">
                    ...
                    <input type="text" 
                          ...
                          id="RoomDetails" 
                          name="RoomDetails"  
                          value="<?php if (isset($_GET['RoomDetails'])) echo($_GET['RoomDetails']); ?>"
