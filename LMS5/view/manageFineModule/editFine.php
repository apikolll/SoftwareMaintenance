...
<?php
	...
	if(isset($_GET['ID']))
	{
		...
		$query = "SELECT * FROM calculatefine WHERE id = '".$id."'";
		$result = mysqli_query($conn,$query);
		$row = mysqli_fetch_assoc($result);
?>  
                
				<!-- insert books -->
				<form action="updateFine.php" method="post">
					<center>
						<table border="1">
						<th Colspan="3" style="text-align:center; background-color:#00aea6"><h5><b>Total Fine Record</b></h5></th>
							...
							<tr>
								...
								<td><input type="text" id="days" name="days" placeholder="Total days " value="<?php echo $row['days'];?>"></td>
							</tr>
							
							<tr>
								<th>Fine Amount per day</th>
								<td><input type="text" id="fine" name="fine" placeholder="Fine Amount" value="<?php echo $row['fine'];?>"></td>
							</tr>
							
							<tr>
								<th>Total Fine Amount</th>
								<td><input type="text" id="total" name="total" placeholder="Total Fine" value="<?php echo $row['total'];?>"></td>
							</tr>
						</table><br>
