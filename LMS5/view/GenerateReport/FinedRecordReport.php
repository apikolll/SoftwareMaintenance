...
<html lang="en">
  ...
  <head>
    ...
    <title>Fined Record Reports</title>
  ...
  <body>
          ...
          <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item active" style="background-image: url(assets/img/book/book1.jpg)">
              <div class="carousel-container">
                <div class="container">
                  <h2 class="animate__animated animate__fadeInDown">Fine Records</h2>
                  <p class="animate__animated animate__fadeInUp">Search for records needed, download and view reports are available</p>
    ...
    <a class="arrow arrow-right" title="Go To Room Records" href="../GenerateReport/RoomRentedReport.php"></a>
	  <a class="arrow arrow-left" title="Go To Book Records" href="../GenerateReport/BookReport.php"></a>  
