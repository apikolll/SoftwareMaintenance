...
<html lang="en">
  ...
  <body>
          ...
          <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item active" style="background-image: url(assets/img/book/book1.jpg)">
              <div class="carousel-container">
                <div class="container">
                  <h2 class="animate__animated animate__fadeInDown">Search Book Records</h2>
                  <p class="animate__animated animate__fadeInUp">Search for records needed, download ad view reports are available</p>

                  <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search by Title, ISBN or author" title="Type in a name"><br><br>
    ...
    <!search funtion under going tak siap lagi>
    <script>
          function myFunction() {
