        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url(assets/img/book/book1.jpg)">
            <div class="carousel-container">
              <div class="container">
                <h2 class="animate__animated animate__fadeInDown">REPORT RECORDS MANAGEMENT</h2>
                <p class="animate__animated animate__fadeInUp">
                  <div class="ref">
                    <a href="./BookReport.php">  Book  </a>
                    |
                    <a href="./FinedRecordReport.php">  Fine  </a>
                    |
                    <a href="./RoomRentedReport.php">  Room  </a>
                  </div>
                </p>
              </div>
            </div>
